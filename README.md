...
Cloud based URL re-writer for Squid for Windows (like common used SquidGuard but running in the cloud) is available at https://guard.diladele.com/login/. The article showing how to enable HTTPS decryption on Squid for Windows can be read [here](https://docs.diladele.com/faq/squid/sslbump_squid_windows.html)
